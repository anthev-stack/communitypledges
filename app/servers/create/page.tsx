...
export default function CreateServerPage() {
  ...
  if (!userSettings?.stripePayoutConnected) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center max-w-md">
          <AlertCircle className="w-16 h-16 text-red-400 mx-auto mb-4" />
          <h1 className="text-2xl font-bold text-white mb-4">Stripe Payout Account Required</h1>
          <p className="text-gray-300 mb-6">
            You need to set up your Stripe Express account to create servers and receive payments from community pledges.
          </p>
          <Link
